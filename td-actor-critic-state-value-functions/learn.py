...
class Trainer:
    def __init__(self, env, gif_freq=10):
    ...
    def play_ep(self, render=False):
        ...
        while not done:
            ...
            self.agent.learn(obs, reward, obs_, done)
            obs = obs_
            return_ += reward
            if render:
